			   ...
			   <div class="content">
                ...
                ?>
                                          ...
                                          <td><?php echo $data['nama_lengkap'];?></td>
                                            ...
                                            <td>
                                             <a href="edit_pegawai.php?id_pegawai=<?php echo $data['id_pegawai']; ?>" class="btn btn-primary">Ubah</a>
                                    			<a onclick="return confirm('Yakin ingin menghapus data?')" href="hapus_pegawai.php?id_pegawai=<?php echo $data['id_pegawai']; ?>" class="btn btn-danger">Hapus</a>
                                    		</td>
                                    	</tr>
                                    	<?php  } ?>
                                    </tbody>
