            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="main-header">
                        <h4>Daftar Pesanan di Batalkan</h4>
                    </div>
                </div>
                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
					...
					<tbody>
                        ...
                        <?php
                            ...
                            $no = 1;
                            $brg = mysqli_query($conn,"select * from keranjang k, pelanggan p where k.id_pelanggan=p.id_pelanggan and status='Pembatalan' order by id_keranjang ASC");
                    ...
                    <tr>
                        ...
                        <th><a href="index.php"  class="btn btn-danger">Kembali</a></th>
					</tr>
                    </tfoot>
                </table>
    <br>
