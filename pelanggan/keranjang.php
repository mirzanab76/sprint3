...
$itungtrans = mysqli_query($conn,"select count(id_detail) as jumlahtrans from detail where orderid='$orderid'");
$itungtrans2 = mysqli_fetch_assoc($itungtrans);
$itungtrans3 = $itungtrans2['jumlahtrans'];

if(isset($_GET['idbarang'])){
	$kode = $_GET['idbarang'];
	$q2 = mysqli_query($conn, "delete from detail where id_barang='$kode' and orderid='$orderid'");
	if ($q2) {
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                ...
                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= number_format($b['qwe']); ?></td>
                                <td>Rp. <?= number_format($b['harga'] * number_format($b['qwe'])); ?></td>
                                <td>
                                    <a onclick="return confirm('Yakin ingin menghapus data?')" href="hapuskeranjang.php?id_detail=<?php echo $b['id_detail']; ?>" class="btn btn-danger btn-xs">Hapus</a>
                                </td>
                            </tr>
                            <?php
						}
                ...
                <div class="input-group-btn">
                    ...
                    <input type="hidden" name="idbarang" value="<?php echo $b['id_barang'] ?>" \>
                </div>
            </div>
        </div>
